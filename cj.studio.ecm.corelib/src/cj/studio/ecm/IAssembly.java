...
/**
 * <p><b>Assembly</b></p>
 * An assembly contains a chip, and the assembly uses logical chips to organize
 * and isolate services or types.
 *
 * <h2>Features</h2>
 * <ul>
 *   <li>Provides capabilities such as modularization, OSGi, and IOC containers.</li>
 * </ul>
 *
 * <h2>Important Note</h2>
 * <p>
 * When developing your assembly project, <b>do not launch the main function</b>
 * within this assembly. Otherwise, the type boundaries that belong to the assembly
 * will be loaded into the application startup context, compromising the encapsulation
 * of the assembly.
 * </p>
 * <p>
 * If a main function is required, encapsulation demands that the caller must be
