...
import cj.ultimate.net.sf.cglib.core.ClassInfo;
...
implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
      TypeUtils.parseType("cj.ultimate.net.sf.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
      TypeUtils.parseType("cj.ultimate.net.sf.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
      TypeUtils.parseType("cj.ultimate.net.sf.cglib.proxy.MethodInterceptor");
