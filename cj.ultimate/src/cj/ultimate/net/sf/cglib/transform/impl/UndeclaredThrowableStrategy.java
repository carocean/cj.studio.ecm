...
import cj.ultimate.net.sf.cglib.core.ClassGenerator;
import cj.ultimate.net.sf.cglib.core.DefaultGeneratorStrategy;
import cj.ultimate.net.sf.cglib.core.GeneratorStrategy;
import cj.ultimate.net.sf.cglib.core.TypeUtils;
import cj.ultimate.net.sf.cglib.transform.ClassTransformer;
import cj.ultimate.net.sf.cglib.transform.MethodFilter;
import cj.ultimate.net.sf.cglib.transform.MethodFilterTransformer;
import cj.ultimate.net.sf.cglib.transform.TransformingClassGenerator;
